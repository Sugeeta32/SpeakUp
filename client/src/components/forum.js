            ...
            <Fragment>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        {loggedIn ? (
                                <Link to="/newstory" className="btn  btn-secondary active float-right" role="button">Create New Story</Link>
                            ) : (
                                    <Link to="/login" className=" btn btn-secondary active float-right" role="button">Create New Story</Link>
                                )}
                            </div>
